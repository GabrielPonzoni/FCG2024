...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 6.e! -- Gabriel Ponzoni", nullptr, nullptr);
	...
	// Estrela
	int ePoints = 3;
	GLuint VAO = createStar(ePoints, 0.2, 0.5);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.9f, 0.3f, 1.0f, 1.0f);
		glDrawArrays(GL_LINE_LOOP, 0, ePoints);
...
int createStar(int nPoints, float minRadius, float maxRadius)
{
	...
	// Configura�ao dos Buffer VBO e VAO
	GLuint VBO, VAO;
	//Geração do identificador do VBO
	glGenBuffers(1, &VBO);
	//Faz a conexão (vincula) do buffer como um buffer de array
